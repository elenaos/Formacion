...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.org/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.org/", "helloWorldResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.org/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.org/", name = "helloWorldResponse")
